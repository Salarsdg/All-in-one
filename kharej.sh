...
SERVER1_IPV4=$(validate_input "" "Enter kharej ipv4: ")
SERVER2_IPV4=$(validate_input "" "Enter iran ipv4: ")

# Ask for IPv6 addresses
IPV6_1=$(validate_input "" "Enter kharej IPv6 address (e.g., 2001:db8:xxxx::1): ")
IPV6_2=$(validate_input "" "Enter iran IPv6 address (e.g., 2001:db8:xxxx::2): ")
